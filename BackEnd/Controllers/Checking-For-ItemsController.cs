...
namespace Lost_and_Found.Controllers
{
    ...
    public class Checking_For_ItemsController : ControllerBase
    {
        ...
        public async Task<IActionResult> MatchCard([FromQuery] string email, [FromQuery] MatchType matchType)
        {
            ...
            // استخدم HttpClient واحد فقط
            using var client = new HttpClient
            {
                Timeout = TimeSpan.FromMinutes(5)
            };

            var url = "http://localhost:8000/match_card/";
            ...
            foreach (var card in lostCards)
            {
                ...
                var jsonString = JsonConvert.SerializeObject(matchRequest);
                ...
                try
                {
                    ...
                    if (!response.IsSuccessStatusCode)
                    {
                        ...
                        continue; // تجاهل الفشل واستمر في المحاولة التالية
                    }
                ...
                {
                    Console.WriteLine($"Error sending match data: {ex.Message}");
                    // استمر بدل ما توقف الكل بسبب كارت واحد
                }
            }
        ...
        //    var url = "http://127.0.0.1:8001/match/";
        ...
        public async Task<IActionResult> MatchPhone([FromQuery] string email, [FromQuery] MatchType matchType)
        {
            ...
            var url = "http://localhost:8000/match_phone/";
